...
describe('GET /lives', function(){
  ...
  it('should return 9 lives', function(done){
    server.inject({method: 'GET', url: '/lives', credentials: {_id: 'abcdefabcdefabcdefab0001'}}, function(response){
      expect(response.statusCode).to.equal(200);
      expect(response.result.lives).to.have.length(9);
      done();
    });
  });
